...
registerOnClick('chrome black', false, false, [0,1,2], false, function(event) {
    assignMat('stand', 'chrome.black', undefined);
}, function(event) {});
registerOnClick('chrome', false, false, [0,1,2], false, function(event) {
    assignMat('stand', 'chrome', undefined);
}, function(event) {});
registerOnClick('chrome white', false, false, [0,1,2], false, function(event) {
    assignMat('stand', 'chrome.white', undefined);
}, function(event) {});

registerOnClick('slab 1', false, false, [0,1,2], false, function(event) {
    replaceTexture('wood material 01', 'wood.', 'wood_basecolor_1.jpg', false, function() {});
}, function(event) {});

registerOnClick('slab 2', false, false, [0,1,2], false, function(event) {
    replaceTexture('wood material 01', 'wood.', 'wood_basecolor_2.jpg', false, function() {});
}, function(event) {});

registerOnClick('slab 3', false, false, [0,1,2], false, function(event) {
    replaceTexture('wood material 01', 'wood.', 'wood_basecolor_3.jpg', false, function() {});
}, function(event) {});
